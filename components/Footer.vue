      ...
      <div class="lg:w-1/5 items-center space-y-8">
        ...
        <form class="relative">
          <input
            ...
            der="Filter projects"
          />
          <Button color="primary" class="absolute right-0 top-1/2 transform -translate-y-1/2 rounded-r-md">Send</Button>
        </form>
    
        <div class="space-y-2">
          <a href="#" class="flex items-center space-x-2 text-primary-500">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 18"
            ...
            <span class="text-gray-500"> elemesid@gmail.com </span>
          </a>
          <a href="#" class="flex space-x-2 text-primary-500">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
            ...
            <span class="text-gray-500"> 0888 1111 2222 </span>
          </a>
        </div>
      </div>
    </div>
    <div class="p-8">
      <p class="text-center text-gray-500 uppercase">© 2021 Elemes id. All rights reserved</p>
    </div>
  </footer>
</template>